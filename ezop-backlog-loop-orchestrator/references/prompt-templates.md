...
```text
Use $ezop-backlog-loop-orchestrator.
...
If the backlog is not execution-ready, do not silently repair it yourself. Recommend $ezop-delivery-planner first.
If the documentation foundation is too stale or too ambiguous to trust, recommend $ezop-agent-ready-docs first.
