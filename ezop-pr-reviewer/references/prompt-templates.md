...
After the quality review, recommend whether $ezop-security-scanner should do a deeper security pass.
...
$ezop-backlog-loop-orchestrator just completed a batch of work. Review the resulting PR as a final quality gate before merge.
The individual slices were already reviewed by $ezop-slice-reviewer for plan compliance.
