...
If they do not, tell me whether I should run $ezop-agent-ready-docs or $ezop-delivery-planner next.
...
If the repo is still aligned, say that $ezop-backlog-loop-orchestrator can proceed.
